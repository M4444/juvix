...
- _Relies on_
  + [[llvm/src/Juvix/Backends/LLVM/Compilation]]
  + [[llvm/src/Juvix/Backends/LLVM/Parameterization]]
  + [[llvm/src/Juvix/Backends/LLVM/Pipeline]]
  + [[llvm/src/Juvix/Backends/LLVM/Primitive]]
******* Compilation <<LLVM/src/Juvix/Backends/LLVM/Compilation>>
- _Relies on_
  + [[llvm/src/Juvix/Backends/LLVM/Codegen/Block]]
  + [[llvm/src/Juvix/Backends/LLVM/Codegen/Closure]]
  + [[llvm/src/Juvix/Backends/LLVM/Codegen/Record]]
  + [[llvm/src/Juvix/Backends/LLVM/Codegen/Sum]]
  + [[llvm/src/Juvix/Backends/LLVM/Codegen/Types]]
  + [[llvm/src/Juvix/Backends/LLVM/Codegen/Types/CString]]
  + [[llvm/src/Juvix/Backends/LLVM/Pass/Conversion]]
  + [[llvm/src/Juvix/Backends/LLVM/Pass/Types]]
  + [[llvm/src/Juvix/Backends/LLVM/Primitive]]
  + [[Ann]]
  + [[Library]]
  + [[Library/Feedback]]
  + [[NameSymbol]]
******* Parameterization <<LLVM/src/Juvix/Backends/LLVM/Parameterization>>
...
- _Relies on_
  ...
  + [[Library]]
******* Pipeline <<LLVM/src/Juvix/Backends/LLVM/Pipeline>>
...
- _Relies on_
  ...
  + [[Library]]
  + [[Juvix/Pipeline]]
******* Primitive <<LLVM/src/Juvix/Backends/LLVM/Primitive>>
...
- _Relies on_
  ...
  + [[Library]]
******* Codegen
******** Block <<LLVM/src/Juvix/Backends/LLVM/Codegen/Block>>
...
- _Relies on_
  ...
  + [[Library]]
  + [[HashMap]]
******** Closure <<LLVM/src/Juvix/Backends/LLVM/Codegen/Closure>>
- _Relies on_
  + [[llvm/src/Juvix/Backends/LLVM/Codegen/Block]]
  + [[llvm/src/Juvix/Backends/LLVM/Codegen/Types]]
  + [[Library]]
******** Constants <<LLVM/src/Juvix/Backends/LLVM/Codegen/Constants>>
Module for predefined constants
- _Relies on_
  + [[Library]]
******** Record <<LLVM/src/Juvix/Backends/LLVM/Codegen/Record>>
- _Relies on_
  + [[llvm/src/Juvix/Backends/LLVM/Codegen/Block]]
  + [[llvm/src/Juvix/Backends/LLVM/Codegen/Types]]
  + [[llvm/src/Juvix/Backends/LLVM/Pass/Types]]
  ...
  + [[HashMap]]
  + [[NameSymbol]]
******** Sum <<LLVM/src/Juvix/Backends/LLVM/Codegen/Sum>>
- _Relies on_
  + [[llvm/src/Juvix/Backends/LLVM/Codegen/Block]]
  + [[llvm/src/Juvix/Backends/LLVM/Codegen/Closure]]
  + [[llvm/src/Juvix/Backends/LLVM/Codegen/Types]]
  + [[llvm/src/Juvix/Backends/LLVM/Codegen/Types/Shared]]
  + [[llvm/src/Juvix/Backends/LLVM/Pass/Types]]
  + [[Library]]
  + [[HashMap]]
  + [[NameSymbol]]
******** Types <<LLVM/src/Juvix/Backends/LLVM/Codegen/Types>>
- _Relies on_
  + [[llvm/src/Juvix/Backends/LLVM/Codegen/Types/CString]]
  + [[llvm/src/Juvix/Backends/LLVM/Codegen/Types/CString]]
  + [[llvm/src/Juvix/Backends/LLVM/Codegen/Types/Shared]]
  + [[llvm/src/Juvix/Backends/LLVM/Codegen/Types/Sum]]
  + [[Library]]
  + [[HashMap]]
********* CString <<LLVM/src/Juvix/Backends/LLVM/Codegen/Types/CString>>
Defines a type for \00 terminated strings
- _Relies on_
  + [[Library]]
  + [[Library]]
********* Shared <<LLVM/src/Juvix/Backends/LLVM/Codegen/Types/Shared>>
Shared between Types and Sum
- _Relies on_
  + [[llvm/src/Juvix/Backends/LLVM/Codegen/Types/CString]]
  + [[Library]]
  + [[HashMap]]
********* Sum <<LLVM/src/Juvix/Backends/LLVM/Codegen/Types/Sum>>
...
- _Relies on_
  + [[llvm/src/Juvix/Backends/LLVM/Codegen/Constants]]
  + [[llvm/src/Juvix/Backends/LLVM/Codegen/Types/Shared]]
  + [[Library]]
  + [[HashMap]]
******* Pass
******** Conversion <<LLVM/src/Juvix/Backends/LLVM/Pass/Conversion>>
- _Relies on_
  + [[llvm/src/Juvix/Backends/LLVM/Pass/Types]]
  + [[llvm/src/Juvix/Backends/LLVM/Primitive]]
  + [[Ann]]
  ...
  + [[HashMap]]
  + [[NameSymbol]]
******** Types <<LLVM/src/Juvix/Backends/LLVM/Pass/Types>>
- _Relies on_
  + [[llvm/src/Juvix/Backends/LLVM/Primitive]]
  + [[Core/Base/Types]]
  + [[Ann]]
