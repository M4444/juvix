...
data Object carrier
  ...
  | Vertex (Shape carrier) Natural
  | ProductObject (Shape carrier) [Object carrier]
  | FunctorObject (Functor' carrier)
...
data Morphism carrier
  ...
  | Edge (Shape carrier) Natural
  | ProductMorphism (Shape carrier) [Morphism carrier]
  | ProjectMorphism (Shape carrier) (Object carrier) (Category carrier)
  | AdjunctionUnit (Adjunction carrier) (Object carrier)
  | AdjunctionCounit (Adjunction carrier) (Object carrier)
...
data Diagram carrier
  ...
  | SingletonDiagram (Object carrier)
  | DiscretePairDiagram (Object carrier) (Object carrier)
  | ParallelPairDiagram (Morphism carrier) (Morphism carrier)
  | SpanDiagram (Morphism carrier) (Morphism carrier)
  | CospanDiagram (Morphism carrier) (Morphism carrier)
  deriving
    ( Read,
      Show,
      Eq,
...
data Functor' carrier
  ...
  | -- | An object of a functor category, viewed as a functor.
    FunctorCatObject (Object carrier)
  | ProjectFunctor (Shape carrier) (Object carrier) (Category carrier)
  | -- | The free functor generated by a diagram.
    FunctorDiagram (Diagram carrier)
  | LeftAdjoint (Adjunction carrier)
  | RightAdjoint (Adjunction carrier)
...
data FAlgebra carrier = FAlgebra
  { fAlgFunctor :: Functor' carrier,
    fAlgObj :: Object carrier,
    fAlgMorphism :: Morphism carrier
  }
...
data Adjunction carrier
  ...
  | FreeForgetfulAlgebra (Functor' carrier)
  | ForgetfulCofreeAlgebra (Functor' carrier)
