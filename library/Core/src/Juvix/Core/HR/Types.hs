...
{-# COMPLETE Star, PrimTy, Prim, Pi, Lam, Sig, CatProduct, CatCoproduct, CatProductIntro, CatProductElimLeft, CatProductElimRight, CatCoproductIntroLeft, CatCoproductIntroRight, CatCoproductElim, Pair, Let, UnitTy, Unit, Elim, Effect #-}
