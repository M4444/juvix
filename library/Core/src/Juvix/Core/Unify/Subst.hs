...
appSubstV' = \case
  ...
  VCatProduct a b -> VCatProduct <$> appSubstV' a <*> appSubstV' b
  VCatCoproduct a b -> VCatProduct <$> appSubstV' a <*> appSubstV' b
  VCatProductIntro a b -> VCatProductIntro <$> appSubstV' a <*> appSubstV' b
  VCatProductElimLeft b s -> VCatProductElimLeft <$> appSubstV' b <*> appSubstV' s
  VCatProductElimRight a t -> VCatProductElimRight <$> appSubstV' a <*> appSubstV' t
  VCatCoproductIntroLeft s -> VCatCoproductIntroLeft <$> appSubstV' s
  VCatCoproductIntroRight t -> VCatCoproductIntroLeft <$> appSubstV' t
  VCatCoproductElim a b s t e ->
    VCatCoproductElim
      <$> appSubstV' a
      <*> appSubstV' b
      <*> appSubstV' s
