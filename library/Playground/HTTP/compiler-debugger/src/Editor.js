...
const API_URL = process.env.API_URL || "https://www.juvix-api.heliax.dev"
...
`,
  ...
  parse() {
    ...
    axios.post(`${API_URL}/pipeline/parse`,
  ...
  typecheck() {
    console.log(this.state.code)
    axios.post(`${API_URL}/pipeline/typecheck`,
      JSON.stringify({ code: this.state.code, backend: this.state.backend }),
      {
        headers: {
          'Content-Type': 'application/json',
  ...
  compile() {
    console.log(this.state.code)
    axios.post(`${API_URL}/pipeline/compile`,
      JSON.stringify({ code: this.state.code, backend: this.state.backend }),
      {
        headers: {
          'Content-Type': 'application/json',
